...
from gui_invoice import InvoiceWindow   # import giao diện hóa đơn
...
class AdminApp(tk.Tk):
    def __init__(self, store, auth):
        ...
        ttk.Button(btns, text="📊 Thống kê đơn hàng", width=20, command=self._open_invoice_stats, style="Accent.TButton").pack(side="left", padx=10)
    ...
    def _open_invoice_stats(self):
        win = InvoiceWindow(self.auth, mode="admin")
        win.grab_set()